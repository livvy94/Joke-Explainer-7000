...
class TestMetadata(unittest.TestCase):
    ...
    def test_metadata_issue(self, mock_details, mock_videos):
        ...
        self.assertTrue(f"`Arrangement` field not present in at least 50% of existing videos in playlist." in msgs)
        self.assertTrue(f"`Platlist` field not present in at least 50% of existing videos in playlist." in msgs)
